...
lines(density(rnorm(100, res$medias[1], res$desvpadrao[1]), bw = 40),lwd=2,col=3)
lines(density(rnorm(100, res$medias[2], res$desvpadrao[2]), bw = 40),lwd=2,col=4)

## column with 2 classes to classified data from each cluster
attach(res$classe)
...
lines(density(rnorm(100, res$medias[1], res$desvpadrao[1]), bw = 40),lwd=2,col=3)
lines(density(rnorm(100, res$medias[2], res$desvpadrao[2]), bw = 40),lwd=2,col=4)
lines(density(rnorm(100, res$medias[3], res$desvpadrao[3]), bw = 40),lwd=2,col=5)

## column with 3 classes to classified data from each cluster
attach(res$classe)
